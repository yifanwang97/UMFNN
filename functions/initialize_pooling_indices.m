function [pool_index] = initialize_pooling_indices(param, h_dim)
...
if param.pooling_size ~= 0
    ...
    temp = [ones(param.pooling_size*2+1),zeros(param.pooling_size*2+1,h_dim-1);zeros(h_dim-1,param.pooling_size*2+h_dim)];
    n = 0;
